...
const sizeClasses: Record<AnimatedCounterSize, string> = {
  sm: "text-[length:var(--ant-typography-fontSize-base)] font-[var(--ant-typography-fontWeight-semibold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
  md: "text-[length:var(--ant-typography-fontSize-md)] font-[var(--ant-typography-fontWeight-bold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
  lg: "text-[length:var(--ant-typography-fontSize-xl)] font-[var(--ant-typography-fontWeight-bold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
  xl: "text-[length:var(--ant-typography-fontSize-2xl)] font-[var(--ant-typography-fontWeight-bold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
  "2xl": "text-[length:var(--ant-typography-fontSize-3xl)] font-[var(--ant-typography-fontWeight-bold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
  "3xl": "text-[length:var(--ant-typography-fontSize-4xl)] font-[var(--ant-typography-fontWeight-bold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
  "4xl": "text-[length:var(--ant-typography-fontSize-4xl)] font-[var(--ant-typography-fontWeight-bold)] tracking-tight leading-[var(--ant-typography-lineHeight-tight)]",
};
  ...
  (
    ...
    return (
      <span
        ...
        className={clsx(
          "inline-flex items-baseline font-[family-name:var(--ant-typography-fontFamily-sans)] tabular-nums select-none antialiased",
          sizeClasses[size],
          colorClasses[color],
          className
        )}
